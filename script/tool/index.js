    ...
    data: {
        ...
        toolObj: {
            ...
            list: [
                ...
                { img: 'tool_12.png', tit: '闹钟', text: '努力开发中', url: './alarm.html' },
                { img: 'tool_11.png', tit: '倒数计时器', text: '多事件同时倒数，不限个数，可加备注<br/>智能提示，有效提醒', url: './countdown.html' },
                { img: 'tool_13.png', tit: '秒表', text: '支持一键分段计次，不限记录次数<br/>精准计算间隔时长', url: './stopwatch.html' }
            ]
        }
    },
    mounted: function() {
